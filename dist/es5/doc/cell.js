...
Cell.prototype = {
  ...
  get _hyperlinks() {
    return this.worksheet.hyperlinks;
  },

  get hyperlink() {
    return this._hyperlinks.find(this.address);
  },

  set hyperlink(value) {
    this._hyperlinks.add(this.address, value);
  },

  get isHyperlink() {
    return this._hyperlinks.find(this.address) !== undefined;
  },
